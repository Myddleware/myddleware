    ...
    protected function setUp(): void
    {
        ...
        $this->entityManager = $kernel->getContainer()
            ...
            if ($count == 0) {
                ...
                $sql = "INSERT INTO `document` VALUES ('66435b3019bad4.47813999', '64807163f1b23', 10, 10, '2024-05-14 12:38:08', '2024-05-14 12:38:08', 'Error_sending', '8', '67', '2023-06-22 06:35:16', '0', 'U', 1, 'Error', '', 1, '')";
