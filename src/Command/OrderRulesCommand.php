...
class OrderRulesCommand extends Command
{
    ...
    {
        $this
            ->setName('myddleware:orderrules')
            ->setDescription('Order rules');
    }
    ...
    {
        $data = $this->jobManager->initJob('ruleorder ');
        ...
        $response = $this->jobManager->orderRules();
