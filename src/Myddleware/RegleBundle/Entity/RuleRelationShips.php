 ...
 * RuleRelationShips
 * 
 * @ORM\Entity(repositoryClass="Myddleware\RegleBundle\Entity\RuleRelationShipsRepository")
 * @ORM\HasLifecycleCallbacks()
 * @ORM\Table(indexes={@ORM\Index(name="Krule_id", columns={"rule_id"})})
 */
 
class RuleRelationShips
{
    /**
     * @var string
     *
     * @ORM\Column(name="rrs_id", type="integer")
     * @ORM\Id
     ...
     * @var string
     *
     * @ORM\Column(name="rrs_field_name_source", type="string", length=100, nullable=false)
	 * 
     */
     ...
     * @var string
     *
     * @ORM\Column(name="rrs_field_name_target", type="string", length=100, nullable=false)
	 * 
     */
     ...
     * @var integer
     *
	 * @ORM\Column(name="rrs_field_id", type="string", length=100, nullable=true)
	 * 
     */
    private $fieldId;     
