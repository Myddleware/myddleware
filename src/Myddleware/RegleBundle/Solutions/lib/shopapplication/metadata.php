...
$moduleFields = array (
					...
					'orders_billing_address' =>
						array(
							'id' => array('label' => 'ID order', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__gender' => array('label' => 'Delivery address gender', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0, 'option' => array('m' => 'Homme', 'f' => 'Femme')),
							'billing_address__name' => array('label' => 'Delivery address name', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__company' => array('label' => 'Delivery address company', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__phone' => array('label' => 'Delivery address phone', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__street_address' => array('label' => 'Delivery address street_address', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__suburb' => array('label' => 'Delivery address suburb', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__doorcode' => array('label' => 'Delivery address doorcode', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__floor' => array('label' => 'Delivery address floor', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__city' => array('label' => 'Delivery address city', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__postcode' => array('label' => 'Delivery address postcode', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__state' => array('label' => 'Delivery address state', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__country' => array('label' => 'Delivery address country', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),
							'billing_address__country_code' => array('label' => 'Delivery address country code', 'type' => 'varchar(255)', 'type_bdd' => 'varchar(255)', 'required' => 0),							
						),		
					'orders_products' =>
						array(
