...
class LoadFunctionData implements FixtureInterface
{
	...
	protected $functionData = array(
									...
									'text'			=> array('trim','lower','upper','substr','striptags','changeValue','htmlEntityDecode','replace','utf8encode','utf8decode','htmlentities','htmlspecialchars','strlen','urlencode'),
