...
class myddlewareFormulaV1core {
	...
	private function secureFunction() {
		...
		$array = array('mb_strtolower','trim','mb_strtoupper','round','ceil','abs','mb_substr','str_replace','preg_replace', 'strip_tags', 'date', 'utf8_encode', 'utf8_decode','html_entity_decode','htmlentities','htmlspecialchars','strlen','urlencode');
