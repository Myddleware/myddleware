INSERT INTO Template VALUES ('5404aac4879c6','1','2');

INSERT INTO TemplateLang (`tpll_lang`, `tplt_id`, `tpll_name`, `tpll_description`) VALUES ('FR','5404aac4879c6','tpl1SgSf','Synchronisation des comptes, contacts et opportunités de SugarCRM vers Salesforce.');
INSERT INTO TemplateLang (`tpll_lang`, `tplt_id`, `tpll_name`, `tpll_description`) VALUES ('EN','5404aac4879c6','tpl1SgSf','Synchronising SugarCRM accounts, contacts and opportunities to Salesforce.');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `Rule` (`rule_id`,`conn_id_source`,`conn_id_target`,`rule_date_created`,`rule_date_modified`,`rule_created_by`,`rule_modified_by`,`rule_module_source`,`rule_module_target`,`rule_active`,`rule_deleted`,`rule_name`,`rule_name_slug`,`rule_version`) VALUES ('idRule','idConnectorSource','idConnectorTarget',NOW(),NOW(),'idUser','idUser','Accounts','Account','0','0','prefixRuleName_SgSf_compte','prefixRuleName_SgSf_compte','001') ");

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `RuleParams` (`rule_id`,`rulep_name`,`rulep_value`) VALUES ('idRule','rate','5'),
('idRule','delete','60'),
('idRule','mode','0'),
('idRule','datereference',CONCAT( CURDATE( ),' 00:00:00' )),
('idRule','duplicate_fields','Name') ");

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `RuleFields` (`rule_id`,`rulef_target_field_name`,`rulef_source_field_name`,`rulef_formula`) VALUES ('idRule','Name','name',''),
...
INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_compte_001_source` (
  `id_prefixRuleName_SgSf_compte_001_source` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id_prefixRuleName_SgSf_compte_001_source`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_compte_001_target` (
  `id_prefixRuleName_SgSf_compte_001_target` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Name` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `Website` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_prefixRuleName_SgSf_compte_001_target`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_compte_001_history` (
  `id_prefixRuleName_SgSf_compte_001_history` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Name` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AnnualRevenue` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `BillingCity` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `BillingCountry` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `Sic` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Website` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_prefixRuleName_SgSf_compte_001_history`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `Rule` (`rule_id`,`conn_id_source`,`conn_id_target`,`rule_date_created`,`rule_date_modified`,`rule_created_by`,`rule_modified_by`,`rule_module_source`,`rule_module_target`,`rule_active`,`rule_deleted`,`rule_name`,`rule_name_slug`,`rule_version`) VALUES ('idRule','idConnectorSource','idConnectorTarget',NOW(),NOW(),'idUser','idUser','Contacts','Contact','0','0','prefixRuleName_SgSf_contact','prefixRuleName_SgSf_contact','001') ");
...
INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `RuleRelationShips` (`rule_id`,`rrs_field_name_source`,`rrs_field_name_target`,`rrs_field_id`) VALUES ('idRule','account_id','AccountId','#BEG#SgSf_compte#END#') ");

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `RuleFields` (`rule_id`,`rulef_target_field_name`,`rulef_source_field_name`,`rulef_formula`) VALUES ('idRule','LastName','last_name',''),
...
INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_contact_001_source` (
  `id_prefixRuleName_SgSf_contact_001_source` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id_prefixRuleName_SgSf_contact_001_source`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_contact_001_target` (
  `id_prefixRuleName_SgSf_contact_001_target` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id_prefixRuleName_SgSf_contact_001_target`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_contact_001_history` (
  `id_prefixRuleName_SgSf_contact_001_history` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `LastName` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Birthdate` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Description` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Email` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `Title` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountId` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_prefixRuleName_SgSf_contact_001_history`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `Rule` (`rule_id`,`conn_id_source`,`conn_id_target`,`rule_date_created`,`rule_date_modified`,`rule_created_by`,`rule_modified_by`,`rule_module_source`,`rule_module_target`,`rule_active`,`rule_deleted`,`rule_name`,`rule_name_slug`,`rule_version`) VALUES ('idRule','idConnectorSource','idConnectorTarget',NOW(),NOW(),'idUser','idUser','Opportunities','Opportunity','0','0','prefixRuleName_SgSf_opportunite','prefixRuleName_SgSf_opportunite','001') ");
...
INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `RuleFields` (`rule_id`,`rulef_target_field_name`,`rulef_source_field_name`,`rulef_formula`) VALUES ('idRule','CloseDate','date_closed',''),
('idRule','Name','name',''),
('idRule','StageName','sales_stage',''),
('idRule','Description','description','') ");

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_opportunite_001_source` (
  `id_prefixRuleName_SgSf_opportunite_001_source` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `date_closed` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `name` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sales_stage` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8_unicode_ci,
  `account_id` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_prefixRuleName_SgSf_opportunite_001_source`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_opportunite_001_target` (
  `id_prefixRuleName_SgSf_opportunite_001_target` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `CloseDate` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Name` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `StageName` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Description` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountId` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_prefixRuleName_SgSf_opportunite_001_target`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_opportunite_001_history` (
  `id_prefixRuleName_SgSf_opportunite_001_history` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `CloseDate` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Name` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `StageName` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Description` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountId` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_prefixRuleName_SgSf_opportunite_001_history`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `Rule` (`rule_id`,`conn_id_source`,`conn_id_target`,`rule_date_created`,`rule_date_modified`,`rule_created_by`,`rule_modified_by`,`rule_module_source`,`rule_module_target`,`rule_active`,`rule_deleted`,`rule_name`,`rule_name_slug`,`rule_version`) VALUES ('idRule','idConnectorSource','idConnectorTarget',NOW(),NOW(),'idUser','idUser','opportunities_contacts','OpportunityContactRole','0','0','prefixRuleName_SgSf_relContOppt','prefixRuleName_SgSf_relContOppt','001') ");
...
INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `RuleRelationShips` (`rule_id`,`rrs_field_name_source`,`rrs_field_name_target`,`rrs_field_id`) VALUES ('idRule','contact_id','ContactId','#BEG#SgSf_contact#END#') ");
INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', "INSERT INTO `RuleRelationShips` (`rule_id`,`rrs_field_name_source`,`rrs_field_name_target`,`rrs_field_id`) VALUES ('idRule','opportunity_id','OpportunityId','#BEG#SgSf_opportunite#END#') ");

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_relContOppt_001_source` (
  `id_prefixRuleName_SgSf_relContOppt_001_source` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id_prefixRuleName_SgSf_relContOppt_001_source`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_relContOppt_001_target` (
  `id_prefixRuleName_SgSf_relContOppt_001_target` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ContactId` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `OpportunityId` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_prefixRuleName_SgSf_relContOppt_001_target`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');

INSERT INTO `TemplateQuery` (`tplt_id`, `tplq_query`) VALUES ('5404aac4879c6', 'CREATE TABLE `z_prefixRuleName_SgSf_relContOppt_001_history` (
  `id_prefixRuleName_SgSf_relContOppt_001_history` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ContactId` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  `OpportunityId` varchar(684) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_prefixRuleName_SgSf_relContOppt_001_history`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;');
