...
class Salesforce extends Solution
{
    ...
    public function login($connectionParam): void
    {
        ...
        try {
            ...
            $token_request_data = $this->call(url: $token_url, parameters: $post_fields);
    ...
    public function getModules($type = 'source'): ?array
    {
        ...
        try {
            $query_request_data = $this->call(url: $query_url, update:false);
    ...
    public function getModuleFields($module, $type = 'source', $param = null): ?array
    {
        ...
        try {
            $query_request_data = $this->call(url: $query_url);
            ...
            foreach ($query_request_data['fields'] AS $field) {
                ...
                if ($field['type'] == 'picklist') {
                    ...
                    $type_bdd = 'bool';
                } elseif (!in_array($field['type'], $this->validDatabaseTypes)) {
    ...
    public function readData($param): ?array
    {
        ...
        try {
            ...
            do {
                ...
                $query_request_data = $this->call($query);
        ...
        try {
            ...
            foreach ($param['data'] as $idDoc => $data) {
                ...
                if (
                    ...
                    // Call to Salesforce
                    $query_request_data = $this->call(url : $query_url, parameters: $parameters);
    ...
    public function updateData($param): array
    {
        ...
        foreach ($param['data'] as $idDoc => $data) {
            try {
                ...
                $query_request_data = $this->call(url: $query_url, parameters: $parameters, update: true);
    ...
    protected function getWhere($param): string
    {
        ...
        if (!empty($param['query'])) {
            ...
            // Mis en forme de la date de référence pour qu'elle corresponde aux exigences du service Salesforce
            ...
            // Si le module est CampaignMember alors on ne récupère que les membres compatibles avec la règle : piste ou contact
            if ($param['module'] == 'CampaignMember') {
                if (in_array('ContactId', $param['fields'])) {
     ...
     * @throws Exception
     */
    protected function call(string $url, string $method = 'GET', mixed $parameters = [], $update = false): mixed
    {
        ob_start();
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
        if (!$parameters) { // Si l'appel ne possède pas de paramètres, on exécute un GET en curl
