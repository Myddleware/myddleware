...
class Unirest
{
     ...
     *
     * @return stdObj|string response string or stdObj if response is json-decodable
     */
 ...
 *
 * @see http://uk1.php.net/ctype_xdigit
 *
 * @param string $hex
 *
