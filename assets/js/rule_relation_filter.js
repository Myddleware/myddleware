        ...
        $('#myButton').on('click', function() {
            ...
            let newItem = $(`
                <li class="mt-2 d-flex justify-content-evenly align-items-baseline">
                    ...
                    <input type="text" value="${anotherFieldInputVal}" class="form-control filter-input my-3">
                    <input type="text" value="${textareaFieldInput}" class="form-control filter-input my-3">
